...
* **Red Hat OpenShift AI (RHOAI) URL:** link:https://data-science-gateway.{openshift_cluster_ingress_domain}[https://data-science-gateway.{openshift_cluster_ingress_domain},window=_blank]
* **Username:** {openshift_cluster_admin_username}
* **Password:** {openshift_cluster_admin_password}
...
* **Measure tail latency scientifically** with benchmarking tools (P95, P99, TTFT (Time to First Token))
* **Identify latency bottlenecks** - prefill queuing, KV (Key-Value) cache misses, queue depth variability
...
=== Module 5: Analyse benchmark results with AI-assisted coding (20 minutes)

Use an AI coding assistant to analyse and visualise your benchmark data:

* Open a pre-configured VS Code workbench in OpenShift AI
* Use OpenCode (an AI coding assistant) to write Python analysis code
* Generate an HTML comparison page showing the performance difference between scaled vLLM and llm-d

**Outcome**: A self-contained HTML report comparing all benchmark metrics, built with AI-assisted coding.
