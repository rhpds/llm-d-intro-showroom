...
* **Module 5**: Use AI-assisted coding to analyse benchmark results and build a comparison report

**Your job**: Generate the data, compare the numbers, and build a visual report.